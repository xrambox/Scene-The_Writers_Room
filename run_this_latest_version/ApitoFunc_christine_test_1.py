...
def generate_initial_scene(data: dict):
    ...
    prompt = (
        ...
        "Introduce the setting, the characters, and establish a dramatic tone, but do not include any scene heading. You MUST only generate a response in maximum 20 tokens otherwise I will punish you. Never include any dialogue in your output."
    )
...
def generate_narrative(data: dict):
    ...
    prompt = (
        ...
        "Focus solely on narrative elements and dialogue, and do not include any explicit scene headings. You MUST only generate a response in maximum 20 tokens otherwise I will punish you. Never include any dialogue in your output."
    )
...
def generate_ending_scene(data: dict):
    ...
    prompt = (
        ...
        "Tie up loose ends and write an ending scene that leaves a lasting cinematic impact.You MUST only generate a response in maximum 20 tokens. Never mention any scene heading and return in plain text only. Never include any dialogue in your output."
    )
