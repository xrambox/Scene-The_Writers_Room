...
# Define the input data based on Sahar's story
test_input = {
    "setting": "A refugee shelter in Germany during the Christmas holidays.",
    "characters": [
        {"name": "Sahar", "trait": "a determined Iranian artist seeking asylum"},
        {"name": "A Muslim couple", "trait": "residents who follow strict religious beliefs"},
        {"name": "Esma", "trait": "an elderly Arab woman"},
        {"name": "Najib", "trait": "a young Afghan teenager"},
        {"name": "Shahla", "trait": "a young Iranian woman"},
        {"name": "Amir", "trait": "a young Iranian man"},
        {"name": "Kübra", "trait": "a pregnant Turkish woman"},
        {"name": "Emil", "trait": "her supportive husband"},
        {"name": "Danny", "trait": "Sahar's beloved dog from Iran"}
    ]
}
